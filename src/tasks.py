...
class CustomTasks():
    ...
    def research(self, agent):
        return Task(description=dedent(f"""                         
            ...
            A 2 page research report style and should consists of headers and subheaders each with 5-7 sentences of summarized bullet points.
    ...
    def write_report(self, agent):
        return Task(
            description=dedent(f"""\
                ...
                Ensure that the report is clear, concise, and easy to understand for a {self.agent_type} audience.
    ...
    def summary_and_briefing_task(self, agent):
        return Task(
			description=dedent(f"""\
                ...
                the output should be a one page final report.
                """),
			agent=agent
		)
